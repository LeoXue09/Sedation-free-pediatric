...
# from model_comparison.Unet_3D_stride import unet_model_3d

os.environ["CUDA_VISIBLE_DEVICES"] = "2"

class SR_UnetGAN():
    def __init__(self):
        self.data_path = '/media/data/uni/ultra_fast/data/h5_file/AC_15s_300s_SUV/data.h5'
        self.save_dir = '/media/data/uni/ultra_fast/result/AC_15s_300s_SUV'
        self.img_shape = (1,96,96,112)
